...
/* modified in 2013-08-20 */
// 删除在某些block前后添加的多余的"\n"
// 修改 doFencedCodeBlocks($text)，将代码块标记设置为```而不是默认的~~~
// 修改 _doFencedCodeBlocks_callback($matches)，添加<pre>的class的属性，以便使用Google code prettify语法高亮
// 修改 transform()，去掉返回值后添加的'\n'
/* end of modified in 2013-08-20 */
...
class _MarkdownExtra_TmpImpl extends Markdown {
	...
	public $code_class_prefix = "lang-"; //// <code>标签的class属性前缀
	...
	protected function _doFencedCodeBlocks_callback($matches) {
		...
		if ($classname != "") {
			...
			$attr_str = ' class="' . $this->code_class_prefix . $classname. ' prettyprint linenums pre-scrollable' . '"';
		} else {
