...
<div id="navigation" class="clearfix">
    ...
    <li><a href='#'>分类</a>
        ...
        ?>
        <li><a href="<?= SITE_URL ?>category.php?term_id=<?= $term['term_id'] ?>"
               title=""><?= $term['term_name'] ?></a></li>
        <?php endforeach ?>
        </ul>
    </li>
    <li><a href="<?= SITE_URL ?>admin/write_log.php" title="">写博客</a>
    </li>
    ...
    <li><a href='#'>管理</a>
        ...
        <li><a href='#'>管理博客</a>
            <ul>
            <li><a href="<?= SITE_URL ?>admin/admin_log.php" title="">管理</a></li>
            <li><a href="<?= SITE_URL ?>admin/write_log.php" title="">写博客</a></li>
            </ul>
        </li>
        <li><a href='#'>管理收藏</a>
            <ul>
            <li><a href="<?= SITE_URL ?>admin/admin_link.php"
                   title="">管理</a></li>
            <li><a href="<?= SITE_URL ?>collect.php" title="">查看</a></li>
            <li><a href="<?= SITE_URL ?>link.php" title="">添加</a></li>
            </ul>
        </li>
        <li><a href='#'>管理相册</a>
            <ul>
            <li><a href="<?= SITE_URL ?>admin/admin_album.php"
                   title="">管理 </a></li>
            <li><a href="<?= SITE_URL ?>link.php" title="">添加</a></li>
            </ul>
        </li>
