...
<div id="write-log-edit" class="span10">
    ...
    <form id="write-log-form" enctype='multipart/form-data' action="<?= $_SERVER['REQUEST_URI'].'#btn-group-submit' ?>" method="post">
        ...
        <div id="btn-group-submit">
            <button class="btn" type="submit" name="publish_submit" value="publish">发布文章</button>
            <button class="btn" type="submit" name="draft_submit" value="draft">保存草稿</button>
            <?php echo isset($publish_success_div) ? $publish_success_div : ''?>
        </div>
